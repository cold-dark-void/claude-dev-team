...
if [ "$USE_DB" = "true" ]; then
  ...
  MEMORY_ID=$(sqlite3 -cmd ".timeout 5000" "$MEMDB" "INSERT INTO memories(agent, type, content) VALUES ('ic4', '<TYPE>', '$ESCAPED');
    SELECT last_insert_rowid();") \
    || { sleep 1; MEMORY_ID=$(sqlite3 -cmd ".timeout 5000" "$MEMDB" "INSERT INTO memories(agent, type, content) VALUES ('ic4', '<TYPE>', '$ESCAPED');
      SELECT last_insert_rowid();"); }
...
mkdir -p "$WTROOT/.claude/memory/ic4"
