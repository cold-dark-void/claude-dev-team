...
name: retro
description: |
  Session retrospective protocol for /retro. Phase-1 friction gate, multi-host
  session discovery, phase-2 subagent spawn, routing/dedup, trial review, and
  confirm/apply. Not user-invoked — commands/retro.md resolves this file.
user-invocable: false
---

# /retro

Protocol for `/retro` (SPEC-012). Thin command host: `commands/retro.md`
(PDH-resolves this skill). Phase-1 gate: `skills/retro-gate/`. Phase-2 prompt:
`skills/retro-subagent/`. Locate/normalize: `skills/transcript-parse/`.
