...
# cross-reviewer, phase4-brief, judge, unconstrained-reviewer, lens-reviewer,
# quorum-analyst (--blind path, CDT-46-C3).
#
...
COVERED="claim-extractor plan-extractor investigator topic-classifier cross-reviewer phase4-brief judge unconstrained-reviewer lens-reviewer quorum-analyst"
DEFERRED=""
