...
```
  $ git worktree add ../project-POC-123 -b feat/POC-123-batch-export
  ...
  Worktree ready at ../project-POC-123. Switch there to continue.
```

```
> (switching terminal to ../project-POC-123)
  cd ../project-POC-123
```
...
```
  Resolving roots...
  Worktree found: ../project-POC-123
...
```
  ...
  About to remove worktree at ../project-POC-123.
...
```
  $ git worktree remove ../project-POC-123
  ✓ Removed worktree
