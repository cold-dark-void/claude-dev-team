...
| 2026-09-25 | SPEC-030 amended (WP 1-02, CDT-270, CDT-419): quarantine emptied; R16 widened to `$MROOT/.claude/`, `TMPDIR` and `HOME`; R18–R21 exit-77 skip protocol (`tests/lib/skip.sh`) and hermetic helper (`tests/lib/hermetic.sh`). SPEC-018 M19.11 one parent fence for `/handoff` (CDT-266, W1-27). |
