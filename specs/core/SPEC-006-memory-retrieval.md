...
**Covers**: `skills/memory-recall/SKILL.md`, `/memory search` (`commands/memory.md`), `commands/recall.md`
...
| Date | Change |
|------|--------|
| 2026-07-22 | CDT-46-C3: retarget Covers `commands/memory-search.md` → `/memory search` (`commands/memory.md`). Status stays ACTIVE. |
