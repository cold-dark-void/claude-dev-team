...
- **M3d — Assemble (LLM-free).** Assemble MUST stay LLM-free and MUST:
  - **(1) Dedup** on `(kind + normalized quote/text)` (first wins) **before** section selection.
