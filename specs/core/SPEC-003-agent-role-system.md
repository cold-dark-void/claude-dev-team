...
- MUST treat shipped frontmatter `model:` as the **Tier default**. Runtime routing via the **Model map** is SPEC-037. This spec remains SoT for which tier each behavioral agent is assigned. SPEC-037 MUST NOT rewrite `agents/*.md`.
