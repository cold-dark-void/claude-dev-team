...
There is no replacement command. Work that previously went through /local-do should use the normal agent flow: assign the task to an IC agent directly via the orchestrator or /fix-ticket.
